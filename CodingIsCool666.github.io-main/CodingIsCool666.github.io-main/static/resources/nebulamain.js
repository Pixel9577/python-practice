...
function log() {
  ...
  setTimeout(
    console.log.bind(
      console,
      "%c If you are seeing this, Knowledger's main script has succesfully loaded!",
